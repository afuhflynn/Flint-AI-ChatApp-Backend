  ...
  <div class="email-container">
    ...
    <div class="email-content">
      ...
      <p class="deletion-message">
        Hi, [user_name]!</p>
      <p>
        We’ve received a request to delete your Flint AI account. If you didn’t make this request, or if you’ve changed your mind, you can cancel the process by clicking the button below.
      </p>
