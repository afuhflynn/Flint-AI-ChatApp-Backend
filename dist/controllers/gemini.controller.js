...
export const getGeminiResponse = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
    ...
    try {
        ...
        if (chatID === "new-chat" || !foundUser) {
            ...
            const newChatTitle = yield genAITitleEndPoint(prompt);
            ...
            if (foundUser) {
                (_a = foundUser === null || foundUser === void 0 ? void 0 : foundUser.chats) === null || _a === void 0 ? void 0 : _a.push({
                    id: newChatID,
                    title: newChatTitle,
            ...
            const currentChat = (_b = foundUser.chats) === null || _b === void 0 ? void 0 : _b.find((item) => item.id === chatID);
            // Generate a new ai response
            const newAIResponse = yield genAIEndPoint(prompt, currentChat);
            // Check if any error occured while generate ai response
            if (newAIResponse ===
                "An error occured. Please check your internet connection!") {
                return res.status(509).json({ message: newAIResponse });
            ...
            if (currentChat) {
                ...
                (_c = foundUser.chats) === null || _c === void 0 ? void 0 : _c.map((chat) => {
                    if (chat.id === chatID) {
                        chat = currentChat;
                    }
                });
